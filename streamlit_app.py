...
st.title("Chat with NYDrive Test Copilot")
st.write(
...
if not openai_api_key:
    ...
    if "messages" not in st.session_state.keys():  # Initialize the chat messages history
        st.session_state.messages = [
            {"role": "assistant", "content": "I am NYDrive Test Copilot, your personal assistant. You can ask me about the written test to obtain a driver's license in New York State."}
        ]
